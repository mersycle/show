...
class Hx{
	 ...
	 * 环信-服务器端REST API
	 */
	private $client_id = 'YXA6LVkvYGtkEea19S1Xb6gckQ';
	private $client_secret = 'YXA6KdO7KIyg08PVOLFBzOHdDGEngP0';
	private $org_name = 'geek-job';
	private $app_name = 'geek';
	private $url = 'https://a1.easemob.com/geek-job/geek/';
	/**
	 * 开放注册模式
	 *
